...
test_that("Parameter target should have the prefix target.investigated_as=  ", {
  expect_equal(formatTarget("transcription factor"), "target.investigated_as=transcription%20factor")
})

test_that("If more than one parameter target, both should have the prefix target.investigated_as=  ", {
  expect_equal(formatTarget(c("transcription factor","tag")),
                 "target.investigated_as=transcription%20factor&target.investigated_as=tag")
})
...
# Sample
test_that("Parameter sample should have the prefix replicates.library.biosample.biosample_type=  ", {
  expect_equal(formatSample("primary cell"), "replicates.library.biosample.biosample_type=primary%20cell")
})

test_that("If more than one parameter sample, both should have the prefix replicates.library.biosample.biosample_type=  ", {
  expect_equal(formatSample(c("primary cell","tissue")),
               "replicates.library.biosample.biosample_type=primary%20cell&replicates.library.biosample.biosample_type=tissue")
})
...
test_that("If more than one parameter fType, both should have the prefix files.file_format=  ", {
...
test_that("If more than one parameter assay, both should have the prefix assay_term_name=  ", {
...
test_that("If more than one parameter assembly, both should have the prefix assembly=  ", {
