...
By accessing the clinical data download in the TCGA data menu, the user can verify the survival of different groups.
...
Obs: Depending on the number of samples and the number of probes of interest, this analysis can last anywhere from minutes to days.  The duration of the analysis also depends on the type of machine and hardware on which the analysis is run.
