                           ...
                           box(title = "Prepare",width = NULL,
                               ...
                               radioButtons("prepareRb", "Data type:",
                                            c("SummarizedExperiment" = TRUE,
                                              "Dataframe" = FALSE)),
                               useShinyjs(),
                               checkboxInput("addSubTypeTCGA", "Add subtypes information", value = FALSE, width = NULL),
                               checkboxInput("addClinicalTCGA", "Add clinical information", value = FALSE, width = NULL),
