                           ...
                           box(title = "Create mee object", width = NULL,
                               ...
                               numericInput("elmermetnacut", "cut-off NA samples (%)",
                                ...
                                actionButton("elmerpreparemee",
                                         ...
                                         width: 100%",
                                             icon = icon("floppy-o"))),
                           box(title = "Data input", width = NULL,
                               status = "danger",
                               solidHeader = FALSE, collapsible = TRUE, collapsed = FALSE,
                               shinyFilesButton('elmermeefile', 'Select mee object', 'Please select mee object',
                                                multiple = FALSE),
                               tags$br(),
                               tags$br(),
                               shinyFilesButton('elmerresultsfile', 'Select results object', 'Please select results object',
                                                multiple = FALSE)),
