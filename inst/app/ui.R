                    ...
                    column(2,
                           box(title = "Summary plot",width = NULL,
                               ...
                               box(title = "Parameters",width = NULL,
                                   ...
                                   checkboxInput("summaryShowSampleType", "Highlight sample tyṕe in barchart?", value = FALSE, width = NULL)
                               ),
                               box(title = "Colors control",width = NULL,
                                   solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
                                   colourInput("summarySetsBarColor", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorTP", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorTR", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorTB", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorTRBM", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorTAP", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorTM", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorTAM", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorTHOC", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorTBM", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorNB", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorNT", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorNBC", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorNEBV", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorNBM", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorCELLC", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorTRB", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorCELL", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorXP", "Sets Bar color", value = "#56B4E9"),
                                   colourInput("summaryQueryColorXCL", "Sets Bar color", value = "#56B4E9")
                                   ),
